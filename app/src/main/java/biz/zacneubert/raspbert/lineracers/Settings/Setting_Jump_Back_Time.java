 ...
 */
public class Setting_Jump_Back_Time extends Setting {
    public static String getSavedValue(Context c) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(c);
        String savedValue = sp.getString(Setting_Jump_Back_Time.getKey(), "10");
        return savedValue;
    }
    ...
    public static String getKey() {
        return "JUMP_BACK_TIME";
    }

    @Override
    public View getView(Context c) {
        LayoutInflater inflater = LayoutInflater.from(c);
        return new Setting_Jump_Back_Time_View(inflater, c).getView();
    }
}
